  ...
  return (
    <>
      ...
      <section className="py-20 md:py-28 bg-bg text-fg">
        <div className="mx-auto max-w-4xl px-6">
          <div className="border-2 border-fg p-8 md:p-10 hover:bg-fg hover:text-bg transition-colors">
            ...
            <Link href="/case-studies#trilingual-product-intelligence" className="font-mono text-xs uppercase tracking-widest text-current hover:underline inline-block">
      ...
      <section className="py-20 md:py-28 bg-fg text-bg">
        <div className="mx-auto max-w-4xl px-6">
          <h2 className="font-display text-3xl tracking-tight text-bg mb-6">Need AI that actually works?</h2>
