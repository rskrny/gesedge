    ...
    <>
      ...
      <section className="pb-20 md:pb-28">
        <div className="mx-auto max-w-4xl px-6">
          <div className="bg-warm rounded-xl p-8 md:p-10">
            ...
            <Link href="/case-studies#charter-operations-platform" className="inline-block mt-4 text-sm text-edge font-medium hover:text-edge-dark">
      ...
      <section className="py-20 md:py-28 bg-ink">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-3xl font-bold text-paper">Need a platform built?</h2>
