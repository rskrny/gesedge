                ...
                {[
                  ...
                  <RevealItem key={cap.label}>
                    <div className="card-glass rounded-sm p-6 md:p-8 flex gap-6 group transition-all duration-300 hover:border-border-hover">
                      <span className="text-xs font-medium tracking-wider shrink-0 mt-1" style={{ color: cap.accent }}>
                        {cap.label}
                      </span>
                      <div>
                ...
                >
                  <Link href={`/case-studies/${cs.slug}`} className="block h-full">
                    <div className={`relative h-[160px] bg-gradient-to-br ${projectGradients[i]} overflow-hidden`}>
                      ...
                      />
                      <span
                        className="absolute top-5 left-5 text-xs font-medium tracking-wider uppercase px-3 py-1.5 rounded-sm border"
                      ...
                      {cs.liveUrl ? (
                        <span className="absolute bottom-5 right-5 flex items-center gap-1.5 text-xs text-fg-dim">
                ...
                {stats.map((s) => (
                  <RevealItem key={s.label}>
                    <div className="card-glass rounded-sm p-6 text-center">
                      ...
                      <p className="mt-3 text-xs font-medium uppercase tracking-[0.2em] text-fg-dim">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-3">
              <RevealSection>
                <p className="text-xs font-medium tracking-[0.25em] text-fg-dim uppercase leading-relaxed whitespace-pre-line">
                  {t("home.tech.label")}
                </p>
              </RevealSection>
            </div>
