                  ...
                  <Link href={`/case-studies/${cs.slug}`} className="block h-full">
                    <div className="p-6 md:p-8 flex flex-col gap-4">
                      <div className="flex items-center justify-between">
                        <span
                          className="text-xs font-medium tracking-wider uppercase px-3 py-1.5 rounded-sm border"
                      ...
                      <h3 className="font-display text-xl md:text-2xl font-semibold transition-colors duration-300 mt-2">
                      ...
                      <span
                        className="inline-flex items-center gap-2 text-sm font-display group-hover:gap-3 transition-all duration-300"
